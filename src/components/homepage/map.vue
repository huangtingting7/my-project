    ...
    <div class="content">
      ...
      <div class="leftcontent">
        ...
        <div class="headBottom">
          <div id="myChartBottom" :style="{width: '100%', height: '500px'}"></div>
        </div>
      </div>
      <div class="map">
        <!-- 中国地图 -->
      ...
      <div class="echartinfo">
        <div id="myChartRight" :style="{width: '100%', height: '500px'}"></div>
        <div class="infolist">
          <ul>
          <li class="title">
            <div>加工</div>
        ...
        <div id="myChartRightBottom" :style="{width: '100%', height: '500px'}"></div>
        <div class="infolist">
          <ul>
          <li class="title">
            <div>龙门移动式</div>
...
export default {
  data() {
    return {
      headlist: [
        {id:1, area: '西南办事处', total: 100, firstNum: 20, secondNum: 30, thridNum: 10},
        {id:1, area: '西北办事处', total: 70, firstNum: 40, secondNum: 20, thridNum: 15},
        {id:1, area: '华东办事处', total: 80, firstNum: 50, secondNum: 10, thridNum: 10},
        {id:1, area: '华北办事处', total: 90, firstNum: 30, secondNum: 15, thridNum: 20},
        {id:1, area: '东北办事处', total: 80, firstNum: 30, secondNum: 15, thridNum: 20},
        {id:1, area: '华南办事处', total: 60, firstNum: 30, secondNum: 15, thridNum: 20},
      ],
      infolist: [
    ...
    getRightBottom () {
      ...
      let option = {
          ...
          legend: {
              bottom: 10,
              left: 'center',
              data: ['龙门移动式', '卧式加工中心','立式加工中心','横梁移动式', '高速型材/复材加工中心']
          },
          series : [
              {
                  type: 'pie',
      ...
      let myChart = this.$echarts.init(document.getElementById('myChartRightBottom'))
      // // 使用刚指定的配置项和数据显示图表。
			myChart.setOption(option)
    },
    back(){
